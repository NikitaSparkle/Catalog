...
class SingUpForm(forms.Form):
    ...
    password = forms.CharField(label="Пароль", max_length=16, required=True, widget=forms.PasswordInput)
    password1 = forms.CharField(label="Повторите пароль", max_length=16, required=True, widget=forms.PasswordInput)
